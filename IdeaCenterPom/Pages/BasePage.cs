...
namespace IdeaCenterPom.Pages
{
    public class BasePage
    {
        ...
        public IWebElement LogoutLink =>
           driver.FindElement(By.XPath("//a[@class='btn btn-primary me-3' and contains(text(),'Logout')]"));

        public IWebElement LoginLink =>
           driver.FindElement(By.XPath("//a[@class='btn btn-outline-info px-3 me-2' and contains(text(),'Login')]"));

        public IWebElement SignUpLink =>
           driver.FindElement(By.XPath("//a[@class='btn btn-primary me-3' and contains(text(),'Sign up for free')]"));
    }
}
